...
=== Some things to do...
====Top priorities:
1. Change local DB to PG
2. https://devcenter.heroku.com/articles/heroku-postgres-import-export
3. Allow custom page sections & set 'show' view to format each section
4. Content for current pages
5. Layout for blog 
